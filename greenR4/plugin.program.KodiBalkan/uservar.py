...
ADDONTITLE     = 'BALKAN GREEN WIZARD'
BUILDERNAME    = 'BALKAN GREEN WIZARD'
...
BUILDFILE      = 'https://greenvip.github.io/builds4.txt'
UPDATECHECK    = 0
APKFILE        = 'http://'
...
REPOID         = 'repository.GreenRevolution'

# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML   = 'https://greenVIP.github.io/greenR4/addons.xml'

# Url to folder zip is located in
REPOZIPURL     =  'https://greenvip.github.io/GreenR4/repository.GreenRevolution/'
...
NOTIFICATION   = 'https://wizard.bilosta.org/notification.txt'
...
# Font size of header
FONTHEADER     = 'Font13'
HEADERMESSAGE  = 'BALKAN GREEN WIZARD'
